              ...
              <div class="card shadow">
                ...
                <div class="card-body">
                  ...
                  <small>Status :
                   ...
                   <?php else : ?>
                   <?php endif; ?>
                   <?php if ($pengaduan->status == 1) : ?>Proses
                   <?php else : ?>
                   <?php endif; ?>
                   <?php if ($pengaduan->status == 2) : ?>di Tolak
                   <?php else : ?>
                   <?php endif; ?>
                  ...
                  <a href="<?= base_url('pengadu')?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="card shadow">
                <div class="card-body">
                      ...
                      <div class="card bg-light my-2">
                        <div class="mx-2 my-2">
                          ...
                          <?php if ($t->id_admin == $pengguna['id_admin']) : ?>
                            <a href="<?= base_url('pengadu/del_tanggapan/') . $t->id_pengaduan . '/' . $t->id_tanggapan; ?>" class="btn btn-danger btn-sm float-right" style="margin-top : -25px;"><i class="fa fa-trash"></i></a>
                          <?php endif; ?>
                          <!-- <hr> -->
                          <p><?= $t->tanggapan; ?></p>
                  ...
                  <hr>
                  <form action="<?= base_url('pengadu/add_tanggapan/') . $pengaduan->id_pengaduan; ?>" method="post">
        ...
        <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="<?= base_url('pengadu/edit_status'); ?>" method="post">
